      ...
      builder: (context, i18n, child) => AlertDialog(
          ...
          title: Row(
            children: [
              ...
              Text(i18n.t('Manage Graph Nodes')),
            ],
          ),
          content: SizedBox(
            width: 500,
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              '${i18n.t('Added')} ${toAdd.length} ${i18n.t('node(s)')}, ${i18n.t('removed')} ${toRemove.length} ${i18n.t('node(s)')}',
            ),
          ),
        );
      }
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('${i18n.t('Failed to update graph:')} $e'),
