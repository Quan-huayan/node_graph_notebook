...
class LuaErrorInfo {
  ...
  String toDetailedString() {
    ...
    if (line != null) {
      buffer.writeln('║ 位置: 第${line}行');
      if (column != null) {
        buffer.writeln('║       第${column}列');
      }
    }
...
class LuaErrorHandler {
  ...
  /// 是否为语法错误
  static bool _isSyntaxError(String message) {
  ...
  /// 是否为安全错误
  static bool _isSecurityError(String message) {
    return message.contains('LuaSecurityException') ||
