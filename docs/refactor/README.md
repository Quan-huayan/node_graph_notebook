...
- refactor_status.md 当重构未完成时保留这个，说明本次重构的实施状态。重构完成后应删除。
- refactor_changes.md 重构完成后创建，说明本次重构进行了哪些更改，更改前以及更改后的架构如何，有哪些问题需要解决，发现原来的总架构设计可能哪些地方不合理需要调整重构方向等。
...
- [重构计划](phase_2_plugins/refactor_plan.md)
- [实施状态](phase_2_plugins/refactor_status.md)
