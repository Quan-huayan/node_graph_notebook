// ignore_for_file: public_member_api_docs, unused_field, constant_identifier_names
...
class LuaBindings {
  ...
  LuaBindings(ffi.DynamicLibrary dynamicLibrary)
    : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  LuaBindings.fromLookup(
...
typedef Dartlua_KFunctionFunction =
    int Function(ffi.Pointer<lua_State> L, int status, Dartptrdiff_t ctx);
