...
[LuaCommandServer]   echo "print('Hello')" > C:\Users\...\AppData\Local\Temp\lua_commands\command.lua
[LuaCommandServer]
```
...
tool\lua.bat "print('Hello from command line!')"

REM 方式 2: 直接使用 dart
dart run tool/send_lua_command.dart "print('Hello from command line!')"
```

**Linux/macOS 用户：**
```bash
# 方式 1: 使用 lua.sh 脚本（推荐）
./tool/lua.sh "print('Hello from command line!')"
