      ...
      test('getNode - 获取单个节点', () async {
        ...
        final script = '''
          onGetComplete = function(success, result)
            if success then
              print("获取成功: " .. result.title)
              print("内容: " .. (result.content or "无"))
              _get_success = true
    ...
    group('类型转换测试', () {
      ...
      test('布尔类型转换', () async {
        final script = '''
          ...
          print("激活状态: " .. tostring(isActive))
          print("删除状态: " .. tostring(isDeleted))
        ''';
    ...
    group('性能和边界测试', () {
      ...
      test('长字符串处理', () async {
        ...
        final script = '''
          ...
          print("字符串长度: " .. string.len(longStr))
        ''';
      ...
      test('回调函数应该能够接收多个参数', () async {
        final script = '''
          multiParamCallback = function(a, b, c)
            print("参数1: " .. tostring(a))
            print("参数2: " .. tostring(b))
            print("参数3: " .. tostring(c))
